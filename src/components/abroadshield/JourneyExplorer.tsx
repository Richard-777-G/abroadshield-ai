...
const STATUS_STYLE: Record<Phase["tasks"][number]["status"], string> = {
  done: "text-[oklch(0.82_0.16_165)] bg-[oklch(0.72_0.15_165/0.12)] border-[oklch(0.72_0.15_165/0.35)]",
  active:
    "text-[oklch(0.82_0.16_70)] bg-[oklch(0.78_0.16_70/0.12)] border-[oklch(0.78_0.16_70/0.35)]",
  queued:
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="as-perspective">
          <div className="as-preserve-3d relative">
            {/* connecting path */}
            <div className="absolute left-0 right-0 top-1/2 -z-10 h-px -translate-y-1/2 bg-gradient-to-r from-transparent via-[oklch(0.72_0.15_165/0.35)] to-transparent" />
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className={`rounded-3xl border ${accent.border} as-glass-strong p-6 sm:p-8`}>
              ...
              <div className="mt-6">
                ...
                <ul className="grid gap-2 sm:grid-cols-2">
                  {active.agenticActions.map((action) => (
                    <li
                      key={action}
                      className="flex items-start gap-2 rounded-xl border border-[var(--shield-border)] bg-[oklch(0.2_0.03_220/0.4)] p-3 text-sm text-[var(--shield-text)]"
                    >
              ...
              <div className="mt-6 grid grid-cols-3 gap-px overflow-hidden rounded-2xl border border-[var(--shield-border)]">
                {active.stats.map((s) => (
                  <div
                    key={s.label}
                    className="bg-[oklch(0.2_0.03_220/0.5)] px-3 py-3"
                  >
            ...
            <div className="rounded-3xl border border-[var(--shield-border)] as-glass p-6 sm:p-7">
              ...
              <button
                className="mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-xl border border-[var(--shield-border)] bg-[oklch(0.2_0.03_220/0.5)] py-2.5 text-xs font-semibold text-[var(--shield-text)] transition hover:border-[oklch(0.72_0.15_165/0.4)] hover:bg-[oklch(0.24_0.03_220/0.7)]"
                onClick={() => {
