...
export default function VisionCTA() {
  return (
    <section className="relative w-full overflow-hidden bg-[var(--shield-ink)] py-24 sm:py-32">
      ...
      <div className="pointer-events-none absolute -left-20 top-1/3 h-72 w-72 rounded-full bg-[oklch(0.72_0.15_165/0.15)] blur-3xl" />
      <div className="pointer-events-none absolute -right-20 bottom-1/4 h-72 w-72 rounded-full bg-[oklch(0.78_0.16_70/0.12)] blur-3xl" />
      ...
      <div className="relative mx-auto max-w-4xl px-5 text-center sm:px-8">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <a
              href="#agent"
              className="group inline-flex items-center gap-2 rounded-full bg-[oklch(0.72_0.15_165)] px-6 py-3.5 text-sm font-semibold text-[oklch(0.16_0.02_220)] transition hover:bg-[oklch(0.82_0.16_165)] as-glow-emerald"
            >
            ...
            <a
              href="#pricing"
              className="inline-flex items-center gap-2 rounded-full border border-[var(--shield-border)] bg-[oklch(0.24_0.03_220/0.6)] px-6 py-3.5 text-sm font-semibold text-[var(--shield-text)] backdrop-blur transition hover:border-[oklch(0.72_0.15_165/0.5)]"
            >
              See the tiers
            </a>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-3 sm:grid-cols-3">
            {[
              ...
              return (
                ...
                >
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[oklch(0.72_0.15_165/0.4)] bg-[oklch(0.72_0.15_165/0.1)]">
                    <Icon className="h-4 w-4 text-[oklch(0.82_0.16_165)]" />
                  </span>
                  <div>
