...
export type StudentProfile = JourneyProfileViewModel;

const DEFAULT_PROFILE: StudentProfile = {
  name: "", email: "", origin: "", destination: "", course: "", university: "",
  preferredUniversities: "", careerGoal: "", intake: "", currentPhase: "pre-departure",
  readiness: 0, onboarded: false, documentsTotal: 0, documentsVerified: 0,
};
