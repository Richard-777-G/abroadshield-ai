...
export const FRANCE_POLICY_VERSIONS: PolicyRuleVersion[] = [
  ...
  version({
    ...
    extraction: { id: "fr-vls-ts-validation-extraction-v1", sourceId: "fr-service-public-vls-ts", claim: "VLS-TS validation deadline rule represented by the existing France policy adapter.", extractedAt: vlsEvidence.retrievedAt },
    effectivePeriodStatus: "KNOWN",
    effectiveFrom: vlsEvidence.effectiveDate,
